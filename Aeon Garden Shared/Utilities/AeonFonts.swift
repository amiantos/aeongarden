...
//  Aeon Garden
//
//  Created by Brad Root on 4/23/19.
...
extension UIFont {
    ...
    static let aeonDataTitleFontiPhone = UIFont(name: "HelveticaNeue-Bold", size: 10)!
    ...
    static let aeonDataFontiPhone = UIFont(name: "HelveticaNeue-Bold", size: 10)!
